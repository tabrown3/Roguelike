...
container.bind(StateType.InitBuildMenu).to(InitBuildMenuState).inSingletonScope();
container.bind(StateType.LoadBuildLevel).to(LoadBuildLevelState).inSingletonScope();
